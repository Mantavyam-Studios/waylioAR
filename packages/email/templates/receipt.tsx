...
export const WaylioReceiptEmail = () => (
  <Html>
    <Head />

    <Body style={main}>
      <Preview>Waylio Receipt</Preview>
      <Container style={container}>
        <Section>
          <Row>
            <Column>
              <Img
                src={`${baseUrl}/static/Waylio-logo.png`}
                width="42"
                height="42"
                alt="Waylio Logo"
              />
        ...
        <Section>
          <Text style={cupomText}>
            Save 3% on all your Waylio purchases with Waylio Card.
            <sup style={supStyle}>1</sup>{' '}
            <Link href="https://www.Waylio.com/Waylio-card/">
              ...
              <Section>
                <Row>
                  <Column style={informationTableColumn}>
                    <Text style={informationTableLabel}>Waylio ID</Text>
                    <Link
                      style={{
        ...
        <Section>
          <Row>
            <Column style={{ width: '64px' }}>
              <Img
                src={`${baseUrl}/static/Waylio-hbo-max-icon.jpeg`}
                width="64"
                height="64"
                alt="HBO Max"
                style={productIcon}
            ...
            <Column style={{ paddingLeft: '22px' }}>
              ...
              <Link href="https://www.Waylio.com/" style={productLink}>
                Write a Review
              </Link>
        ...
        <Section>
          <Row>
            <Column align="center" style={block}>
              <Img
                src={`${baseUrl}/static/Waylio-card-icon.png`}
                width="60"
                height="17"
                alt="Waylio Card"
              />
        ...
        <Section>
          <Row>
            <Column align="center" style={ctaTitle}>
              <Text style={ctaText}>Save 3% on all your Waylio purchases.</Text>
            </Column>
          </Row>
        </Section>
        <Section>
          <Row>
            <Column align="center" style={walletWrapper}>
              <Link href="https://www.Waylio.com/" style={walletLink}>
                <Img
                  src={`${baseUrl}/static/Waylio-wallet.png`}
                  width="28"
                  height="28"
                  alt="Waylio Wallet"
                  style={walletImage}
        ...
        <Text style={footerLinksWrapper}>
          <Link href="https://www.Waylio.com/">Account Settings</Link> •{' '}
          <Link href="https://www.Waylio.com/">Terms of Sale</Link> •{' '}
          <Link href="https://www.Waylio.com/legal/privacy/">
            Privacy Policy{' '}
          </Link>
        </Text>
        <Text style={footerCopyright}>
          Copyright © 2023 Waylio Inc. <br />{' '}
          <Link href="https://www.Waylio.com/legal/">All rights reserved</Link>
        </Text>
      </Container>
    </Body>
  </Html>
...
export default WaylioReceiptEmail;
